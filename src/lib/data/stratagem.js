export const Stratagem = {
  ...
  Commando: {
    ...
    content: `
      <p>This missile launcher is equipped with an intelligent laser-guided smart missile system that do track your every intention. Pull the trigger and keep the enemy in sight to continously inform the fired missile of the position of the enemy. No ill-intentioned creature will be able to hide from your constant gaze.</p>
      <p>This beauty is able to dispense democracy up to 4 rockets at a time.</p>
    `
  },
  ...
  Steriliser: {
    ...
    content: `
      ...
      <p>The spray comes equipped with three compounds: Bug Begone, which quickly neutralizes any bugs along with the smells they might leave behind; Civil Diffesent Disinfectant, suppressing circuitry with high corrosive power, and taking care of Pro-Automaton graffiti as a bonus; and Quick Xpand, a compound that quickly expands when coming into contact with extraterrestrial orifices. Different blends for different threats, created by the finest Super Earth scientists.</p>
      <p>Please note: Despite the name, this tool has not been proven to have any effect on the fertility of its users or fellow Super Earth citizens. Any undesired effects such as, birth defects, chafing, or intercourse-related quarrels are purely coincidental and cannot be attributed to this compound. Please refer to Section 32 of Subsection 731, Chapter 23 of the "Maintaining a lasting future" companion handbook for more details.</p>
